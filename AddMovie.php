...
class AddProduct{
	...
	{
		$sql="insert into movielist(movieId,Name,Genre,Director,Description,image,imdb,Price) values('',?,?,?,?,?,?,?);";

		if(($stmt=$conn->prepare($sql))) {
			$stmt->bind_param("sssssss",$Name,$Genre,$Director,$Description,$image,$imdb,$Price);
